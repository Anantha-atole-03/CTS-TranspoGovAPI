 ...
 * This class is triggered when an unauthenticated user attempts to access a protected 
 * resource without a valid JWT, or if the provided token is expired or malformed.
 */
@Component
public class JwtAuthenticationEntryPoint implements AuthenticationEntryPoint {

	/**
	 * Handles the commencement of an authentication failure (HTTP 401).
	 * This is the first point of failure for users who are not "logged in" correctly.
	 * 
	...
	public void commence(HttpServletRequest request, HttpServletResponse response,
		...
		// Set content type to JSON so the client-side (React/Angular) can parse it easily
