package com.cts.transpogov.utils;
...
public class MailTemplates {
    ...
    private static String baseTemplate(String name, String bodyContent) {
        ...
        return "<html>" +
                ...
                "<h2>TranspoGov Notification</h2>" +
                "</div>" +
                "<div style='padding:20px;'>" +
                "<p>Dear " + name + ",</p>" +
                bodyContent +
                "<br><p>Regards,<br>TranspoGov Team</p>" +
                "</div>" +
                "<div style='background:#f4f4f4;text-align:center;padding:10px;font-size:12px;'>" +
                "&copy; 2026 TranspoGov" +
                "</div>" +
                "</div>" +
                "</body></html>";
    }
    ...
    public static String getNewProgramTemplate(String name, String programTitle, String description) {
        ...
        String content =
                "<p>You have been enrolled in a new transport program.</p>" +
                "<p><b>Program:</b> " + programTitle + "</p>" +
                "<p>" + description + "</p>";
    ...
    public static String getComplianceAlertTemplate(String name, String entityType) {
        ...
        String content =
                "<p>A compliance issue has been detected for:</p>" +
                "<p><b>Entity:</b> " + entityType + "</p>";
    ...
    public static String getRouteUpdateTemplate(String name, String routeTitle) {
        ...
        String content =
                "<p>Your selected route has been updated.</p>" +
                "<p><b>Route:</b> " + routeTitle + "</p>";
    ...
    public static String getUserCreationTemplate(String name, String phone,String password) {
        ...
        String content =
                "<p>Your TranspoGov account has been successfully created.</p>" +
